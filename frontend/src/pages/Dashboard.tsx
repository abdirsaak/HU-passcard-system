...
//   const netPayable = fee * (1 - discount / 100)
...
//   const financeRows: [string, string, boolean][] = [
//     ['Total Fee',   `$${fee.toLocaleString()}`,        false],
//     ['Discount',    `${discount}%`,                    false],
//     ['Net Payable', `$${netPayable.toLocaleString()}`, true ],
//   ]
...
//             <div className="w-9 h-9 rounded-full bg-blue-100 text-blue-600 font-bold text-sm flex items-center justify-center select-none">
//               {initials}
//             </div>
//             <button
//               onClick={onLogout}
//               className="border border-gray-200 text-gray-500 hover:bg-gray-100 rounded-lg px-3 py-1.5 text-sm transition-colors cursor-pointer"
//             >
//               Sign out
//             </button>
//           </div>
...
//               Welcome to your Student Dashboard. Here's an overview of your academic profile.
//             </p>
...
//               />
//             ) : (
//               <div className="w-24 h-24 rounded-full bg-white/20 border-4 border-white/40 text-white font-bold text-3xl flex items-center justify-center shadow-lg">
//                 {initials}
//               </div>
//             )}
...
//             {/* Finance Card */}
//             <div className="bg-white border border-gray-200 rounded-xl shadow-sm p-5">
//               <h2 className="text-sm font-bold text-gray-700 mb-4">💳 Financial Info</h2>
//               <table className="w-full text-sm">
//                 <tbody>
//                   {financeRows.map(([label, value, highlight]) => (
//                     <tr key={label} className="border-b border-gray-100 last:border-0">
//                       <td className="py-2 text-gray-400 w-2/5">{label}</td>
//                       <td className={`py-2 font-bold ${highlight ? 'text-blue-600 text-base' : 'text-gray-800'}`}>
//                         {value}
//                       </td>
//                     </tr>
//                   ))}
...
//                 />
//               ) : (
//                 <div className="w-28 h-28 rounded-full bg-blue-100 text-blue-600 font-bold text-3xl flex items-center justify-center">
//                   {initials}
//                 </div>
//               )}
